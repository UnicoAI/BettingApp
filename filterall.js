         ...
         for (const marketId in foundMarkets) {
                 ...
                 <div class="main-progress-wrap">
                     <div class="progress-slider-items">
                         ...
                         <div class="title">
                             ...
                             <span class="text" style="margin-left:30%"><i class="fas fa-hand-holding-usd"></i> <span class='totalMatched'>${(market.tv || 0).toFixed(2)}</span></span>
             ...
             for (const runner of marketInfo.runners) {
                 ...
                 runnerElement.innerHTML = `
                     <tr>
                         <td class="match-pointing-box" style="border: 2px solid rgba(20, 89, 168, 0.2)">
             ...
             <div class="match-fixing">
                 <div class="match-items">
                     <div class="match-items-left">
                         <div class="cont">
                             <div class="icon">
                                 <img src="../../assets/assets/img/header/right-icon/bets.svg" alt="icon"> Bet Details   
                             </div>
                     ...
                     <div class="match-items-right">
                         ...
                         <table>
                             <tr>
                                 ...
                                 <td><input type="number" min="1.01" step="0.01" name="rate" id="betRate" value="${clickedValue || 0}" required></td>
                             </tr>
                         </table>
                     </div>
                     <div class="match-items-right">
                         <table>
                             <tr>
                                 ...
                                 <td><input type="number" min="1.00" id="betAmount" name="betAmount" value="1" step="0.01"  required></td>
                             </tr>
                         </table>
                     </div>
